...
export const TabContainer = ({ icons, names, children, className = "", setup = () => {}, ...rest }) => {
    ...
    const tabIndicatorLine = Box({
        ...
        child: NavigationIndicator({
            ...
            setup: self => self.hook(shownIndex, self => (self.css = `font-size: ${shownIndex.value}px;`)),
        }),
    });
    ...
    const contentStack = Stack({
        ...
        shown: shownIndex.bind().as(String),
    });
    const mainBox = Box({
        attribute: {
            children: children,
    ...
    const tabs = Box({
        ...
        children: icons.map((icon, i) => {
            ...
            const tabName = DoubleRevealer({
                ...
                duration1: 200,
                duration2: 200,
                child: Label({ className: "margin-left-5 txt-small", label: names[i] }),
            ...
            const button = Button({
                ...
                child: Box({
                    homogeneous: true,
                    children: [Box({ hpack: "center", children: [tabIcon, tabName] })],
                }),
                setup: setupCursorHover,
                onClicked: () => (shownIndex.value = i),
            });
